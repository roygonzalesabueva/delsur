...
<nav class="navbar ">
  ...
  <!--  <ul class="nav navbar-nav">
    ...
    <li>  
    <a href="indexclient_legal.php"> <i class="fa fa-bar-chart" style="font-size:18px"></i><B>Transaction Status</B></a>
          </li>
	...
	<h3 class="text-primary"><B>Legal Office</B></h3>
...
<div class="col-md-1"></div>
  ...
  <a href="transferlegal_record.php?mem_id=<?php echo $fetch['mem_id']?>">Records</a>
  <a href="transferlegal_hrmo.php?mem_id=<?php echo $fetch['mem_id']?>">HRMO</a>
    <a href="transferlegal_sds.php?mem_id=<?php echo $fetch['mem_id']?>">SDS</a>
    <a href="transferlegal_asds.php?mem_id=<?php echo $fetch['mem_id']?>">ASDS</a>
    <a href="transferlegal_sgod.php?mem_id=<?php echo $fetch['mem_id']?>">SGOD</a>
	<a href="transferlegal_cid.php?mem_id=<?php echo $fetch['mem_id']?>">CID</a>
	<a href="transferlegal_dpsu.php?mem_id=<?php echo $fetch['mem_id']?>">DPSU</a>
	<a href="transferlegal_supply.php?mem_id=<?php echo $fetch['mem_id']?>">Supply</a>
	<a href="transferlegal_cashier.php?mem_id=<?php echo $fetch['mem_id']?>">Cashier</a>
    <a href="transferlegal_budget.php?mem_id=<?php echo $fetch['mem_id']?>">Budget</a>
	<a href="transferlegal_acct.php?mem_id=<?php echo $fetch['mem_id']?>">Accounting</a>
    <a href="transferlegal_legal.php?mem_id=<?php echo $fetch['mem_id']?>">Legal</a>
  </div>
</div>
...
<td>
<a href="edit_legal.php?mem_id=<?php echo $fetch['mem_id']?>"><i class="fa fa-edit" style="font-size:16px;color:Blue"><font size="4"><B>Update</B></font></i></a>
