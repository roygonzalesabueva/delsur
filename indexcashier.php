...
<nav class="navbar ">
  ...
  <!--  <ul class="nav navbar-nav">
	...
	<li>  
	<a href="indexclient_cashier.php"> <i class="fa fa-bar-chart" style="font-size:18px"></i><B>Transaction Status</B></a>
        </li>
	...
	<h3 class="text-primary"><B>Cashier's Office</B></h3>
...
<div class="col-md-1"></div>
		<div class="col-md-5">
			...
			<form action="indexcashier.php" method="post" enctype="multipart/form-data">
...
<?php while($fetch = mysqli_fetch_array($search_result)): ?>
  ...
  <a href="transfercashier_record.php?mem_id=<?php echo $fetch['mem_id']?>">Records</a>
  <a href="transfercashier_hrmo.php?mem_id=<?php echo $fetch['mem_id']?>">HRMO</a>
    <a href="transfercashier_sds.php?mem_id=<?php echo $fetch['mem_id']?>">SDS</a>
    <a href="transfercashier_asds.php?mem_id=<?php echo $fetch['mem_id']?>">ASDS</a>
    <a href="transfercashier_sgod.php?mem_id=<?php echo $fetch['mem_id']?>">SGOD</a>
	<a href="transfercashier_cid.php?mem_id=<?php echo $fetch['mem_id']?>">CID</a>
	<a href="transfercashier_dpsu.php?mem_id=<?php echo $fetch['mem_id']?>">DPSU</a>
	<a href="transfercashier_supply.php?mem_id=<?php echo $fetch['mem_id']?>">Supply</a>
	<a href="transfercashier_cashier.php?mem_id=<?php echo $fetch['mem_id']?>">Cashier</a>
    <a href="transfercashier_budget.php?mem_id=<?php echo $fetch['mem_id']?>">Budget</a>
	<a href="transfercashier_acct.php?mem_id=<?php echo $fetch['mem_id']?>">Accounting</a>
    <a href="transfercashier_legal.php?mem_id=<?php echo $fetch['mem_id']?>">Legal</a>
  </div>
</div>
...
<cemter><a href="delcashier.php?mem_id=<?php echo $fetch['mem_id']?>"><i class="fa fa-trash" style='font-size:16px;color:Blue'><font size="4"><B>Del</B></font></i></a></center>
...
<td>
<a href="edit_cashier.php?mem_id=<?php echo $fetch['mem_id']?>"><i class="fa fa-edit" style="font-size:16px;color:Blue"><font size="4"><B>Update</B></font></i></a>
